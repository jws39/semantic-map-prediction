...
from datasets.util.viz_utils import colorize_grid
import cv2
...
def get_acc_proj_grid(ego_grid_sseg, pose, abs_pose, crop_size, cell_size):
    ...
    # print('ego_grid_sseg shape', ego_grid_sseg.shape)
    ...
    # if VIS == 1:
    #     geo_grid_sseg_27 = colorize_grid(geo_grid_sseg.unsqueeze(0), color_mapping=27)
    #     save_dir = "/home/jignwen/Code/L2M/dataset_example/" + str(VIS) + '/geo_grid_sseg_27'
    #     print('save_dir: ', save_dir)
    #     if not os.path.exists(save_dir):
    #         os.makedirs(save_dir)
    #     # print('color_step_ego_grid_27', color_step_ego_grid_27[0][0].numpy().shape)
    #     for i in range(geo_grid_sseg_27.shape[1]):
    #         cv2.imwrite(os.path.join(save_dir, "%s_geo_grid_sseg_27.png" % i),
    #                     geo_grid_sseg_27[0][i].permute(1, 2, 0).numpy()[::-1])
    #
    #     step_geo_grid_sseg_27 = colorize_grid(step_geo_grid_sseg, color_mapping=27)
    #     save_dir = "/home/jignwen/Code/L2M/dataset_example/" + str(VIS) + '/step_geo_grid_sseg_27'
    #     print('save_dir: ', save_dir)
    #     if not os.path.exists(save_dir):
    #         os.makedirs(save_dir)
    #     # print('color_step_ego_grid_27', color_step_ego_grid_27[0][0].numpy().shape)
    #     for i in range(step_geo_grid_sseg_27.shape[1]):
    #         cv2.imwrite(os.path.join(save_dir, "%s_step_geo_grid_sseg_27.png" % i),
    #                     step_geo_grid_sseg_27[0][i].permute(1, 2, 0).numpy()[::-1])
...
def ground_projection(points2D, local3D, sseg, sseg_labels, grid_dim, cell_size):
    ...
    for i in range(sseg.shape[0]): # sequence length
        ...
        # print('points2D_step', points2D_step)
        # print('local3D_step', local3D_step)

        # print('points2D_step len', len(points2D_step))
        # print('local3D_step len', len(local3D_step))
        ...
        # print('points2D_step2 len', len(points2D_step))
        # print('local3D_step2 len', len(local3D_step))
